...
\begin{task}{Twice the fun}
  ...
  \texttt{chachatwo.py} is a program that takes as input two hex-encoded ChaCha20-Poly1305 authenticated ciphertexts.
  Assuming that they were encrypted with the same key and nonce, it recovers the original plaintexts with the help of a wordlist.
  Implement the program based on the template.
