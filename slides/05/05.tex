...
\begin{frame}{What to use}
  ...
  \begin{itemize}[<+(1)->]
    ...
    \item {\scriptsize Other standardised/studied mechanisms, if needed (e.g. Deoxys-II, Ascon). See \href{https://competitions.cr.yp.to/caesar-submissions.html}{\textit{CAESAR}}.}
  \end{itemize}
