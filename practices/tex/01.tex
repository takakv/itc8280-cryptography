...
\begin{task}{Frequency analysis}
  For both the plaintext and the ciphertext of the shift cipher, plot the letter/symbol frequencies on a graph, e.g. with \texttt{matplotlib}\footnote{\url{https://matplotlib.org}}.
