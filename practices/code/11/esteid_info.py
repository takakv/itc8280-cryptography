...
class CC:
    ...
    def _detect(self):
        ...
        elif atr == [0x3B, 0xDC, 0x96, 0x00, 0x80, 0xB1, 0xFE, 0x45, 0x1F, 0x83, 0x00,
                     0x12, 0x23, 0x3F, 0x54, 0x65, 0x49, 0x44, 0x32, 0x0F, 0x90, 0x00, 0xC3]:
            print("Detected card: EstEID 2018 CosmoX")
        else:
